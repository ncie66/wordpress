...
add_action("admin_enqueue_scripts", "load_scripts");
    function load_scripts(){
        wp_enqueue_scripts( "jscolor", get_template_directory_url()."/js/jscolor.min.js" );
}
...
function generate_theme_menu_page(){
    ...
    && isset( $_POST["color_f"] )
        ...
        update_option("custon_colors", $colors );
    }
    ...
    <form method="post">
        ...
        <label> 
            <span>Couleur h1 </span>
        <input type="text" value="colorh[]" />

        </label>

        <label> 
            <span>Couleur h2 </span>
        <input type="text" value="colorh[]" />

        </label>

        <label> 
            <span>Couleur h3 </span>
        <input type="text" value="colorh[]" />

        </label>

        <label> 
            <span>Couleur h4 </span>
        <input type="text" value="colorh[]" />

        </label>

        <label> 
            <span>Couleur h5 </span>
        <input type="text" value="colorh[]" />

        </label>

        <label> 
            <span>Couleur h6 </span>
        <input type="text" value="colorh[]" />
